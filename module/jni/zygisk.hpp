 ...
 * purpose with or without fee, hereby granted.
 *
...
struct Api {
    ...
    // The original function pointer will be saved in each JNINativeMethod *methods, int numMethods);
...
// The function has to accept an integer value, which is a Unix domain socket that is connected to the target process.
// See Api::connectCompanion() for more info.
//
